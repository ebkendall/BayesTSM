...
# ------------------------------------------------------------------------------
# Supporting functions for (gendat) --------------------------------------------
# ------------------------------------------------------------------------------
...
# For comparison, the same data generated for BayesTSM input
set.seed(12052023)
dat.bayestsm = gendat(n = 1000,     # Sample size
...
# par(mfrow=c(1,3))
plot(ecdf(dat.bayestsm$X))
plot(ecdf(dat.bayestsm$S))